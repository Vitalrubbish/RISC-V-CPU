...
class MUL_ALU(Module):
    ...
    def build(
        ...
        alu_a = concat(Bits(1)(0), alu_a)  # Extend alu_a to 33 bits for sign handling
        alu_b = concat(Bits(1)(0), alu_b)  # Extend alu_b to 33 bits for sign handling
        ...
        with Condition(final_product_valid[0] & ~clear):
            ...
            result_array[0] = (final_result[0].bitcast(Int(64)) + final_carry_result[0].bitcast(Int(64))).bitcast(Bits(64))[0:31] # 取低32位作为结果，注意截取两边都是闭的
